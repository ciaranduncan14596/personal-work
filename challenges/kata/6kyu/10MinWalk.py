...
will return true if the walk the app gives you will take you exactly ten minutes (you don't want to be early or late!) 
...
def is_valid_walk(walk):
    ...
    for direction in walk:
        ...
        print(directions[0], directions[1])
    if directions[0] == 0 and directions[1] == 0:
        return True
    return False

a = is_valid_walk(['w', 'e', 's', 'w', 'e', 'w', 'n', 'e'])
print(a)
